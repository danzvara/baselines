...
This code is a modification of OpenAI GAIL baseline according to GAIfO (Generative
Adversarial Imitation from Observations).
'''
...
def main(args):
    ...
    if args.task == 'train':
        dataset = Gaifo_Dset(expert_path=args.expert_path, traj_limitation=args.traj_limitation)
